...
typedef ipc_obj_return_code_t (*ipc_hdl_dispatch_fn_t)(int sock, const nvlist_t *nvl);
...
ipc_obj_return_code_t ipc_obj_dispatch(int sock, const nvlist_t *nvl, const ipc_hdl_dispatch_t dispatch_table[], size_t dispatch_table_size);
